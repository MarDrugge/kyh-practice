...
#         self.age = age
#
# anna = People("Anna", "Persson", 42)
# lova = People("Lova", "Andersson", 35)
# alex = People("Alex", "Börjesson", 10)
#
# people_ls = [anna, lova, alex]
#
# people_ls.sort(key=attrgetter('age'))
# for elem in people_ls:
#     print(f"{elem.first} {elem.last} ({elem.age} år)")
